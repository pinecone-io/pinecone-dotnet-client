...
internal partial class RawClient(ClientOptions clientOptions)
{
    ...
    internal Task<Pinecone.Core.ApiResponse> MakeRequestAsync(
        Pinecone.Core.BaseRequest request,
    ...
    internal async Task<Pinecone.Core.ApiResponse> SendRequestAsync(
        Pinecone.Core.BaseRequest request,
        CancellationToken cancellationToken = default
    )
    {
    ...
    /// </summary>
    private async Task<Pinecone.Core.ApiResponse> SendWithRetriesAsync(
        HttpRequestMessage request,
        IRequestOptions? options,
    ...
    )
    {
        ...
        {
            return new Pinecone.Core.ApiResponse
            {
    ...
    internal HttpRequestMessage CreateHttpRequest(Pinecone.Core.BaseRequest request)
    {
    ...
    private static string BuildUrl(Pinecone.Core.BaseRequest request)
    {
    ...
    /// <inheritdoc />
    [Obsolete("Use Pinecone.Core.ApiResponse instead.")]
    internal record ApiResponse : Pinecone.Core.ApiResponse;

    /// <inheritdoc />
    [Obsolete("Use Pinecone.Core.BaseRequest instead.")]
    internal abstract record BaseApiRequest : Pinecone.Core.BaseRequest;

    /// <inheritdoc />
    [Obsolete("Use Pinecone.Core.EmptyRequest instead.")]
    internal abstract record EmptyApiRequest : Pinecone.Core.EmptyRequest;

    /// <inheritdoc />
    [Obsolete("Use Pinecone.Core.JsonRequest instead.")]
    internal abstract record JsonApiRequest : Pinecone.Core.JsonRequest;

    /// <inheritdoc />
    [Obsolete("Use Pinecone.Core.MultipartFormRequest instead.")]
    internal abstract record MultipartFormRequest : Pinecone.Core.MultipartFormRequest;

    /// <inheritdoc />
    [Obsolete("Use Pinecone.Core.StreamRequest instead.")]
    internal abstract record StreamApiRequest : Pinecone.Core.StreamRequest;
}
